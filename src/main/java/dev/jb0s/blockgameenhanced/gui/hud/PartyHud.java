...
public class PartyHud {
    ...
    private static void renderPartyMember(DrawContext context, PartyMember member, int index) {
        ...
        // Draw Name
        context.drawText(client.textRenderer, Text.of(member.getPlayerName()), contentX + headSize + 5, contentY, 0xFFFFFF, true);
        ...
        if(blackOut) {
            ...
            if(isOutOfRange && member.isAlive()) {
                ...
                context.drawText(client.textRenderer, Text.of("OUT OF RANGE"), centerX, centerY, textColor, true);
            }
