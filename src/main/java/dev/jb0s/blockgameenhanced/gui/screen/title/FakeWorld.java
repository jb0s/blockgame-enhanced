...
public class FakeWorld extends ClientWorld {
    public FakeWorld() {
        super(new FakeClientPlayNetHandler(),
                ...
                World.OVERWORLD,
                new RegistryEntry.Direct<>(DimensionType.create(OptionalLong.empty(), true, false, false, true, 1.0, false, false, true, false, true, 0, 16, 16, BlockTags.INFINIBURN_OVERWORLD, DimensionType.OVERWORLD_ID, 1f)),
                Integer.MAX_VALUE,
